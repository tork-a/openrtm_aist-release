...
## file out setting
test_case = "ServiceProfileSDOPackageTest"
...
## -----------------------------------------------------------------------------
fodat = "get_service_profiles()"
print_file_and_cons(fodat)

for i in range(loop_cnt):
    ## SDOSystemElement::get_service_profiles (); 
    a0.rtc_ref.get_service_profiles()
...
leak_check(rssStart, rssEnd)
## -----------------------------------------------------------------------------
fodat = "get_service_profile()"
print_file_and_cons(fodat)

for i in range(loop_cnt):
    ## SDOSystemElement::get_service_profile (in UniqueIdentifier id); 
    a0.rtc_ref.get_service_profile("ID 1")
...
leak_check(rssStart, rssEnd)
## -----------------------------------------------------------------------------
fodat = "remove_service_profile()"
print_file_and_cons(fodat)

for i in range(loop_cnt):
    ## Configuration::remove_service_profile (in UniqueIdentifier id); 
    config.remove_service_profile("ID 1")
