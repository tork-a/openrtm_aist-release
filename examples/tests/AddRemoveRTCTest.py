...
loop_cnt = 1000
## -----------------------------------------------------------------------------
fodat = "add_component() and remove_component()"
print_file_and_cons(fodat)

for i in range(loop_cnt):
    # ExecutionContext::add_component(in LightweightRTObject comp)
    retcode = ec[0].add_component(seqin0.rtc_ref)

    # ExecutionContext::remove_component(in LightweightRTObject comp)
    retcode = ec[0].remove_component(seqin0.rtc_ref)
